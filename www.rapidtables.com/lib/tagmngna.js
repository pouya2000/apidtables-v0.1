...
function tagmngMain()
{
   ...
   var as2=document.getElementsByClassName("adslot_2");
   var as3=document.getElementsByClassName("adslot_3");
   if( as1.length>0 ) as1[0].style.display="none";
   if( as2.length>0 ) as2[0].style.display="none";
   if( as3.length>0 ) as3[0].style.display="none";
}
